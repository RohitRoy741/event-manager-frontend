    ...
    return (
        <div>
            ...
            <Navbar.Collapse id="basic-navbar-nav" className="navbar-items">
                ...
                <Nav.Link href="#my-events" className="navbar-item" onClick={props.showEvents}>Events</Nav.Link>
                <Nav.Link href="#schedule" className="navbar-item" onClick={props.showSchedule}>Schedule</Nav.Link>
